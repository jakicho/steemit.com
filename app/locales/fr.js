const fr = 	{
	...
	we_require_social_account: 'Steemit rémunère chaque nouveau compte avec ${signup_bonus} de Steem Power; afin d\'éviter les abus, nous demandons aux nouveaux utilisateurs de lier leur compte social.',
	personal_info_will_be_private: 'Vos informations personelles resteront privées',
	...
	subscribe_to_get_sms_confirm: 'Abonnez-vous pour recevoir une notification quand les SMS de confirmation seront disponibles',
	...
	deadline_for_recovery_is: 'Deadline pour la restauration est',
	i_understand_dont_show_again: "Je comprend, ne plus afficher",
	ok: 'Ok',
	...
	user_hasnt_made_any_posts_yet: "Il s\'emblerai que {name} n\'a pas encore publié d\'articles!",
	user_hasnt_started_bloggin_yet: "Il s\'emblerai que {name} n\'a pas encore commencé à blogger!",
	user_hasnt_followed_anything_yet: "Il s\'emblerai que {name} ne suit personne pour l\'instant!",
	...
	// Post.jsx
	now_showing_comments_with_low_ratings: 'Affichage des commentaires avec votes négatifs',
	hide: 'Hide',
	show: 'Show',
	sort_order: 'Sort Order',
	comments_were_hidden_due_to_low_ratings: 'Des commentaires ont été masqués en raison de votes négatifs',
	we_will_be_unable_to_create_account_with_this_browser: 'We will be unable to create your Steem account with this browser',
	you_need_to_logout_before_creating_account: 'Vous devez vous {logoutLink} avant de créer un autre compte',
